 ...
 *
 * Edited by: Lewis Bobrow
 *
 * Due Date: 02/27/19
 *
 * Description: Creates instance of BinarySearchTree, implements functions 
 *              from the class, and prints out the tree and information about
 *              it's height, number of nodes, etc.
 */
